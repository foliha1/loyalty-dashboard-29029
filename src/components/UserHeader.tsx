          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <button 
                ...
                className="relative group cursor-pointer interact-scale min-w-[44px] min-h-[44px]"
              >
                <Avatar className="w-20 h-20 sm:w-22 sm:h-22 md:w-24 md:h-24 border-2 border-tier-accent/50 flex-shrink-0 transition-all duration-500 hover:border-tier-accent hover:shadow-[0_0_20px_hsl(var(--tier-accent)/0.4)]">
